                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            transition-all" key={index}>
                                ...
                                <td className="p-4">
                                    <span className={`text-slate-400 dark:text-white font-medium text-xs px-3 py-1 rounded-full ${getSatusColor(order.status)}`}>
                                        {order.status}
                                    </span>
                                </td>
                                <td className="p-4">
        ...
        border border-slate-200/50 bg-border-slate-700/50 overflow-hidden">
            ...
            <div className="p-6 space-y-4">
                {TopProduct.map((product,index) =>{
                    return <div className="flex items-center justify-between p-4 rounded-xl hover:bg-slate-50
