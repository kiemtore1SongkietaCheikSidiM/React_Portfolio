        ...
        <>
            <footer className="flex flex-col bg-slate-50 items-center justify-around w-full py-16 text-sm text-gray-800/70">
                <div className="flex items-center gap-8">
                    ...
                    <a href="mailto:kiemtorecheik@gmail.com" className="font-medium text-gray-500 hover:text-black transition-all">
                        Mails
                    </a>
                    <a href="#" className="font-medium text-gray-500 hover:text-black transition-all">
                        56 14 12 34
                ...
                <div className="flex items-center gap-4 mt-8 text-indigo-500">
                    <a href="https://www.facebook.com/mohamed.kiemtore.351" className="hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <a href="https://github.com/kiemtore1SongkietaCheikSidiM" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="mt-8 text-center">Copyright © 2025 <a href="https://github.com/kiemtore1SongkietaCheikSidiM"></a>. All rights reservered.</p>
            </footer>           
        </>
    )
}