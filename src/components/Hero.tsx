...
const Hero = () =>{
    return (
        <section className="flex justify-around items-center p-10 space-x-10 lg:flex-row sm:flex-col sm:space-y-10 text-white bg-violet-500">
            ...
            <div>
                <p className="text-emerald-400 ml-10 mb-5 w-96 text-center text-3xl">Welcome</p>
