...
const menuItems = [
    ...
    },
    {
        ...
        lien: "Analyse",
        submenu : [
            {id : "Liste des depenses", label: "Liste des depenses"},
            {id: "Evolution des ventes", label: 'Evolution des ventes'},
            {id:"Evolution de la sante", label: "Evolution de la sante"},
            {id:"Nature de la mortalite", label: "La mortalite"},
            {id:"Decision", label: "Decision"},
            {id:"Impact attendu", label: "Impaact attendu"}
        ],
    },
    {
        id: "Client",
...
function Sidebar({collapsed,ontoggle,currentPage,onPageChange,Theme}){
                      ...
                      {/* Conditional rendering*/}
                        ...
                        {!collapsed && (
                          ...
                          <span className='font-medium ml-2'>
                            <Link to={item.lien}>{item.label}</Link>
                          </span>
                          {item.badge && (
